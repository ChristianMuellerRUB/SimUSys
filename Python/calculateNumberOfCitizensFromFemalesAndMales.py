# -*- coding: utf-8 -*-
# --------------------------------------------------------------------
# Name: calculateNumberOfCitizensFromFemalesAndMales.py
# calculates the number of citizens from number of females and males
# --------------------------------------------------------------------
...
rScript = os.path.join(rScriptPath, "calculateNumberOfCitizensFromFemalesAndMales.r")
