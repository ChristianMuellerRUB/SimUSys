# -*- coding: utf-8 -*-
# --------------------------------------------------------------------
# Name: aggregateEnvironmentToAnalysisGrid.py
# --------------------------------------------------------------------
...
if (os.path.isfile(os.path.join(modelFolder, "highestResAttributes_Env.csv")) == False):
    rScript = os.path.join(rScriptPath, "getEnvironmentEntitiesWithHighestResolution.r")
...
userTab = []
with open(os.path.join(modelFolder, "highestResAttributes_Env.csv"), 'r') as csvfile:
