# calculateSumsOfFeaturesPerGridCell_line.r
...
# hande case 2
dat[case_big2small, toField] <- AreaIntermediate[case_big2small]/totAreas[case_big2small] * OrigData[case_big2small]
